...
const Footer = () => {
  ...
  return (
    <div className='w-full h-[80px] min-h-[65px] bg-gray-900 flex flex-col justify-center items-center'>
        <div className='text-sm text-gray-500 flex justify-center items-center my-2'>
          <a href='https://www.linkedin.com/in/likith-koneru-a604bb262/' className='px-2'>
            ...
            <a href="https://www.instagram.com/_._silent.storm_._/" className='px-2'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
            ...
            <a href="https://github.com/PHOEN1X-OG" className='px-2'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>

...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div id="Latest" className=" hidden w-[92%] h-[200px] my-5 flex flex-col bg-red-950 text-white rounded-xl">
        ...
        <div className="card flex items-center h-[88%] w-[300px] bg-amber-900 hover:bg-amber-800 rounded-md my-2 mx-2 transition duration-500">
      ...
      <Cardcollection devclass="Latest"/>
      <Cardcollection devclass="Best-in-Class"/>
      <Cardcollection devclass="Upcoming"/>
    </div>
  );
}
